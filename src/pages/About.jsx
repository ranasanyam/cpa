...
const About = () => {
  return (
    <div className='relative top-[96px] bg-[#E5EEF6] overflow-hidden min-h-screen'>
      <div className='w-4/5 mx-auto '>
        <div className='py-20'>
          <div className='font-bold text-4xl mb-8 text-center md:text-left'>About Us</div>
          <div className='bg-light-100 p-8 rounded-md md:rounded-lg'>
          <div>
            <span className='font-semibold'>Anuj Mehra</span> is a highly accomplished financial professional, holding prestigious credentials as a CPA (Certified Public Accountant) licensed in the States of Michigan and Colorado, as well as a Chartered Professional Accountant (CPA) in Canada and a Chartered Accountant (CA) in India. He also possesses an MBA, further enhancing his extensive expertise in the field of accounting, finance, and taxation. With over 22 years of experience, Anuj has developed a robust understanding of financial practices in the U.S. and globally.
            Throughout his illustrious career, Anuj has worked with some of the most renowned firms in the industry, including PwC, EY, and Deloitte. His tenure with these Big 4 firms has provided him with a wealth of experience across a diverse range of accounting and taxation practices. This experience, combined with his deep knowledge of regulatory standards and financial frameworks, allows Anuj to deliver exceptional value to his clients in the USA.
            Anuj is proficient in U.S. Generally Accepted Accounting Principles (GAAP), Sarbanes-Oxley Act (SOX) Section 404 compliance, and International Financial Reporting Standards (IFRS). His expertise spans various sectors, including consumer products, industrial operations, and service-based businesses, enabling him to offer tailored financial solutions that meet the unique needs of each industry.
          ...
          <div className='pt-6 mb-10'>
            ...
            <div className='text-center font-bold text-xl md:text-2xl py-2 rounded-md md:rounded-lg lg:text-4xl'>
