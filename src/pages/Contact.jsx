...
const Contact = () => {
  return (
    ...
    <div className='w-4/5 mx-auto font-roboto'>
      <div className='py-20'>
        <div className='font-bold text-4xl mb-8 text-center md:text-left'>Contact Us</div>
        <div className='mt-10 bg-white py-10 px-10 lg:px-20'>
          <div className='font-bold text-light-300 text-xl mb-2'>OFFICE</div>
          
            <div className='font-bold text-xl md:text-2xl lg:text-3xl'>1871 Golf Ridge Drive S, Bloomfield Twp, MI 48302</div>
            ...
            <div className='flex flex-col md:flex-row text-2xl font-bold mt-6'>
              <div className='md:mr-10 mb-5 md:mb-0'><span className='mr-2 text-[#F26522]'><EmailIcon /></span>amsm@email.com</div>
              <div><span className='mr-2 text-[#F26522]'><CallIcon /></span>+1 (248) 787-0502</div> 
            </div>
            ...
            <hr></hr>
            <div className='mt-10'>
              <div className='font-bold text-light-300 text-xl mb-6'>CONTACT FORM</div>
              <div className='font-bold text-xl md:text-2xl lg:text-3xl'>How can we help</div>
              <div>
