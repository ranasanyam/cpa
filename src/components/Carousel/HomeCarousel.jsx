  ...
  return (
    <div className="bg-home relative bg-cover bg-no-repeat pt-[120px] min-h-screen font-catamaran flex items-center justify-center">
        <div className="md:w-11/12 lg:w-4/5 mx-auto flex flex-col-reverse md:flex-row justify-evenly items-center md:justify-between h-full p-4">
            <div className="w-full md:w-1/2 text-center md:text-left py-10">

                <div className="text-primary-100 my-4 md:my-6 font-bold text-3xl lg:text-4xl xl:text-5xl">
                    Financial Consulting<br></br> For Your Business
                </div>
            ...
            <div className='w-full xs:w-4/5 sm:w-2/3 flex justify-center md:justify-end md:w-1/3'>
                <div>
